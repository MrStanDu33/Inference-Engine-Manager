...
@section ("content")
	<section id="dashboard" class="">
		...
		<ul id="listActions" class="flex row wrap xSpaceAround yCenter">
			...
			<li class="block"><a href="/gestion" class="flex column nowrap xCenter ySpaceAround"><img class="actionIcon" src="https://via.placeholder.com/150" alt="Action icon"/>Insertion de données</a></li>
